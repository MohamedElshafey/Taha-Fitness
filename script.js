function func() {	
	...
	document.getElementById("output3").innerHTML =  "You need  " + Math.round(totalCaloriesPerDay +500 ).toFixed(2) +  " Calories/day to gain 0.5 kg per week.";
	document.getElementById("output3").innerHTML =  "You need  " + Math.round(totalCaloriesPerDay +1000 ).toFixed(2) + " Calories/day to gain 1 kg per week.";
